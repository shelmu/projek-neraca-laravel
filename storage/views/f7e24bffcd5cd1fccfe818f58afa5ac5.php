        ...
        <div class="col-md-4">
            <div class="card h-100 bg-dark border-secondary shadow-sm">
                <div class="card-body border-start border-4 border-primary">
                    ...
                    <div class="h2 mb-0 fw-bold text-white"><?php echo e($total_user); ?></div>
                </div>
            </div>
        </div>
        <!-- Total Admin -->
        <div class="col-md-4">
            <div class="card h-100 bg-dark border-secondary shadow-sm">
                <div class="card-body border-start border-4 border-danger">
                    ...
                    <div class="h2 mb-0 fw-bold text-white"><?php echo e($total_admin); ?></div>
                </div>
            </div>
        </div>
        <!-- Total Anggota Biasa -->
        <div class="col-md-4">
            <div class="card h-100 bg-dark border-secondary shadow-sm">
                <div class="card-body border-start border-4 border-success">
                    ...
                    <div class="h2 mb-0 fw-bold text-white"><?php echo e($total_anggota); ?></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="table-responsive">
                ...
                <table class="table table-dark table-hover mb-0 align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="ps-4 fw-bold text-secondary"><?php echo e($user->nim); ?></td>
                            ...
                            <td class="text-end pe-4">
                                <div class="d-flex justify-content-end gap-2">
                                    <!-- TOMBOL EDIT -->
                                    <a href="<?php echo e(route('anggota.edit', $user->id)); ?>" class="btn btn-sm btn-warning text-dark" title="Edit Data">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>

                                    <!-- TOMBOL HAPUS -->
                                    <form action="<?php echo e(route('anggota.destroy', $user->id)); ?>" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data <?php echo e($user->nama); ?>?');">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\projek-neraca\resources\views/admin/anggota/index.blade.php ENDPATH**/ ?>