...
<?php $__env->startSection('title', 'Input Program Kerja'); ?>
...
<div class="container my-5" style="max-width: 900px;">
    ...
    <div class="card bg-dark border-secondary shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('progja.store')); ?>" method="POST" id="formCreateProgja">
                <?php echo csrf_field(); ?> 
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select bg-dark text-white border-secondary" name="divisi_induk" required>
                                ...
                                <?php $__currentLoopData = ['Litbang', 'Redaksi', 'Organisasi', 'Kreatif', 'Humas', 'Keuangan']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $divisi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($divisi); ?>"><?php echo e($divisi); ?></option>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\projek-neraca\resources\views/admin/progja/create.blade.php ENDPATH**/ ?>