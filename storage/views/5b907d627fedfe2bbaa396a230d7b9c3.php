        ...
        <div class="col-lg-8">
            ...
            <div class="d-grid gap-3 d-sm-flex justify-content-sm-center mb-5">
                <?php if(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('login')); ?>" class="btn btn-warning btn-lg px-5 fw-bold text-dark rounded-pill">
                        Mulai Sekarang
                    </a>
                ...
                <?php else: ?>
                    <div class="alert alert-dark border-secondary d-inline-block px-5 py-3">
                        ...
                        Halo, <strong><?php echo e(Auth::user()->nama); ?></strong>!
                    </div>
                    <div class="mt-3">
                        <?php if(Auth::user()->role == 'admin'): ?>
                            <a href="<?php echo e(route('dashboard.admin')); ?>" class="btn btn-warning fw-bold px-4 rounded-pill">Ke Dashboard Admin</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('dashboard.anggota')); ?>" class="btn btn-warning fw-bold px-4 rounded-pill">Ke Dashboard Anggota</a>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </div>
                    ...
                    <div class="carousel-inner rounded">
                        ...
                        <div class="carousel-item active" data-bs-interval="5000">
                            ...
                            <div class="d-flex align-items-center justify-content-center bg-secondary text-white" style="height: 400px;">
                                    <img src="<?php echo e(asset('img/galeri/pjtd.jpg')); ?>" class="d-block w-100" alt="Pelatihan Jurnalistik">
                            </div>
                        ...
                        <div class="carousel-item" data-bs-interval="5000">
                            <div class="d-flex align-items-center justify-content-center bg-secondary text-white" style="height: 400px;">
                                    <img src="<?php echo e(asset('img/galeri/aksi.jpg')); ?>" class="d-block w-100" alt="Pelatihan Jurnalistik">
                            </div>
                            <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-75 rounded p-2">
                        ...
                        <div class="carousel-item" data-bs-interval="5000">
                            <div class="d-flex align-items-center justify-content-center bg-secondary text-white" style="height: 400px;">
                                    <img src="<?php echo e(asset('img/galeri/wawancara.jpg')); ?>" class="d-block w-100" alt="Pelatihan Jurnalistik">
                            </div>
                            <div class="carousel-caption d-none d-md-block bg-dark bg-opacity-75 rounded p-2">
    ...
    <div class="container text-center py-5">
        ...
        <div class="row g-4">
            ...
            <div class="col-md-4">
                <div class="card h-100 bg-black border-secondary shadow-sm">
                    <!-- Placeholder Gambar -->
                    <img src="<?php echo e(asset('img/produk/website.png')); ?>" alt="Website Neraca">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card h-100 bg-black border-secondary shadow-sm">
                    <img src="<?php echo e(asset('img/produk/majalah.jpg')); ?>" alt="Majalah Neraca">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card h-100 bg-black border-secondary shadow-sm">
                    <img src="<?php echo e(asset('img/produk/sosmed.png')); ?>" alt="Sosmed Neraca">
                    <div class="card-body">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\projek-neraca\resources\views/landing.blade.php ENDPATH**/ ?>