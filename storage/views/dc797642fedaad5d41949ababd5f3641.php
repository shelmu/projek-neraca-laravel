...
<div class="container my-5" style="max-width: 700px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('kas.index')); ?>" class="btn btn-outline-secondary">
    ...
    <div class="card bg-dark border-secondary shadow-sm">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('kas.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label class="form-label text-secondary">Tanggal Transaksi</label>
                        <input type="date" name="tanggal_transaksi" class="form-control bg-dark text-white border-secondary" value="<?php echo e(date('Y-m-d')); ?>" required>
                    </div>
                    <div class="col-md-6">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\projek-neraca\resources\views/admin/kas/create.blade.php ENDPATH**/ ?>