        ...
        <div class="col-md-4">
            <div class="card h-100 bg-dark border-secondary shadow-sm hover-effect">
                <div class="card-body text-center p-5">
                    ...
                    <a href="{{ route('anggota.index') }}" class="btn btn-outline-warning btn-lg w-100 mt-3">
                        Buka Menu
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 bg-dark border-secondary shadow-sm hover-effect">
                <div class="card-body text-center p-5">
                    ...
                    <a href="{{ route('kas.index') }}" class="btn btn-outline-success btn-lg w-100 mt-3">
                        Buka Menu
                    </a>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="card h-100 bg-dark border-secondary shadow-sm hover-effect">
                <div class="card-body text-center p-5">
                    ...
                    <a href="{{ route('progja.index') }}" class="btn btn-outline-danger btn-lg w-100 mt-3">
                        Buka Menu
                    </a>
                </div>
            </div>
